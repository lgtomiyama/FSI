...
namespace Common
{
    public class WSDLParser
    {
        ...
        private void GetOperationFormat(OperationBinding obin, out SoapBindingStyle style, out SoapBindingUse inputUse, out SoapBindingUse outputUse)
        {
            style = SoapBindingStyle.Document;
            inputUse = SoapBindingUse.Literal;
            outputUse = SoapBindingUse.Literal;
        ...
        private TreeNode MessageToTreeNode(OperationMessage omsg, SoapBindingUse use)
        {
            ...
            XSDParser ngen = new XSDParser(_schemas);

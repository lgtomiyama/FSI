...
namespace Common
{
    ...
    public class XSDParser
    {
        ...
        private bool processHasExited = false;
        #endregion
        #region Public Methods
        public XSDParser(XmlSchemas schemas)
        {
            MyInit();
        ...
        private void Create_RootElement(TreeNode inner, XmlQualifiedName qname)
        {
        ...
        private void Add_Element(TreeNode complexNode, string ns, XmlSchemaElement elem)
        {
            //add to complexNode
        ...
        private void Create_CustomType(TreeNode inner, XmlQualifiedName qname)
        {
        ...
        private void Parse_ComplexType(TreeNode inner, XmlSchemaComplexType stype, XmlQualifiedName rootName)
        {
            Parse_ComplexType(inner, stype, rootName, -1);
        }
        private void Parse_ComplexType(TreeNode innerNode, XmlSchemaComplexType stype, XmlQualifiedName rootName, int id)
        {
        ...
        private void Add_ComplexAttributes(TreeNode inner, XmlSchemaComplexType stype)
        {
            Add_Attributes(inner, stype.Attributes, stype.AnyAttribute);
        }
        private void Add_ComplexElements(TreeNode complexNode, string ns, XmlSchemaComplexType stype)
        {
        ...
        private void Add_Attributes(TreeNode innerNode, XmlSchemaObjectCollection atts, XmlSchemaAnyAttribute anyat)
        {
        ...
        private void Parse_ParticleComplexContent(TreeNode complexNode, string ns, XmlSchemaParticle particle)
        {
            Parse_ParticleContent(complexNode, ns, particle, false);
        }
        private void Parse_ParticleContent(TreeNode complexNode, string ns, XmlSchemaParticle particle, bool multiValue)
        {
        ...
        private void Parse_SequenceContent(TreeNode complexNode, string ns, XmlSchemaObjectCollection items, bool multiValue)
        {
            foreach (XmlSchemaObject item in items)
                Add_Item(complexNode, ns, item, multiValue);
        }
        private void Add_Item(TreeNode complexNode, string ns, XmlSchemaObject item, bool multiValue)
        {
        ...
        private void Parse_ChoiceContent(TreeNode inner, string ns, XmlSchemaChoice choice, bool multiValue)
        {
            foreach (XmlSchemaObject item in choice.Items)
                Add_Item(inner, ns, item, multiValue);
        }
        private void Parse_SimpleContent(TreeNode inner, XmlSchemaSimpleContent content)
        {
        ...
        private void Parse_ComplexContent(TreeNode inner, string ns, XmlSchemaComplexContent content)
        {
        ...
        private void Parse_ArrayType(XmlSchemaComplexContentRestriction rest, out XmlQualifiedName qtype)
        {
        ...
        private void Parse_AnyObject(TreeNode inner, XmlSchemaObject obj)
        {
        ...
        private void Parse_SimpleType(TreeNode inner, XmlSchemaSimpleType stype)
        {
        ...
        private void Add_RefType(TreeNode inner, string ns, XmlSchemaElement elem)
        {
        ...
        private void Parse_QueuedType(TreeNode inner)
        {
        ...
        private string GetQualifiedNameString(TreeNode inner, XmlQualifiedName qname)
        {
            TreeNode node = new TreeNode("xmlns q1=" + qname.Namespace);
            return "q1:" + qname.Name;
        }
        private string GetBuiltInTypeName(XmlQualifiedName qname)
        {
            if (qname.IsEmpty)
            {
                return "";
        ...
        private string GetBuiltInType(XmlSchemaSimpleType st)
        {
        ...
        private XmlQualifiedName GetContentBaseType(XmlSchemaObject obj)
        {
        ...
        private XmlSchemaAttribute GetArrayAttribute(XmlSchemaObjectCollection atts)
        {
        ...
        private XmlSchemaElement GetRefElement(XmlSchemaElement elem)
        {
        ...
        private XmlSchemaAttribute GetRefAttribute(XmlQualifiedName refName)
        {
        ...
        private XmlSchemaComplexType GetComplexTypeByName(XmlQualifiedName qname)
        {
        ...
        private XmlSchema FindSchema(string targetNamespace)
        {
            for (int i = 0; i < _schemas.Count; i++)
